...
import com.simple.phonetics.data.dao.RoomIpa.Companion.toEntity
import com.simple.phonetics.data.dao.RoomIpa.Companion.toRoom
...
private const val ipaVersionDao = 1

@Database(entities = [RoomIpa::class], version = ipaVersionDao, exportSchema = false)
