...
@ItemAdapter
class NoneBigTextAdapter : com.simple.adapter.ViewItemAdapter<NoneBigTextViewItem, ItemTextBinding>(), BigTextAdapter {

    override val viewItemClass: Class<NoneBigTextViewItem> by lazy {
        NoneBigTextViewItem::class.java
    }
    ...
    override fun onBindViewHolder(binding: ItemTextBinding, viewType: Int, position: Int, item: NoneBigTextViewItem, payloads: MutableList<Any>) {

        binding(binding, viewType, position, item as BigTextViewItem, payloads)
    }

    override fun onBindViewHolder(binding: ItemTextBinding, viewType: Int, position: Int, item: NoneBigTextViewItem) {

        binding(binding, viewType, position, item as BigTextViewItem)
    }
}

data class NoneBigTextViewItem(
